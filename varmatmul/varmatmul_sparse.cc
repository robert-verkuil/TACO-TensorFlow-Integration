...
class VarMatmulSparseOp : public OpKernel {
 private:
 ...
 public:
  explicit VarMatmulSparseOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("VarMatmulSparse").Device(DEVICE_CPU), VarMatmulSparseOp);
