...
def _mymatmul_grad_cc(op, grad):
    ...
    return mymatmul_grad_module.my_matmul_grad(grad, op.inputs[0], op.inputs[1])
...
def _mymatmul_grad(op, grad):
    ...
    print grad_input, grad_weights
    
    return [grad_weights, tf.transpose(grad_input)]
